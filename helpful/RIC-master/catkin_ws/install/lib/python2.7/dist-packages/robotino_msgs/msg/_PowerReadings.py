...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2I2f.pack(_x.stamp.secs, _x.stamp.nsecs, _x.current, _x.voltage))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.stamp.secs, _x.stamp.nsecs, _x.current, _x.voltage,) = _struct_2I2f.unpack(str[start:end])
      self.stamp.canon()
      return self
