...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-srv:<SetEncoderPosition-request> is deprecated: use robotino_node-srv:SetEncoderPosition-request instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <SetEncoderPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-srv:position-val is deprecated.  Use robotino_node-srv:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <SetEncoderPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-srv:velocity-val is deprecated.  Use robotino_node-srv:velocity instead.")
  (velocity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderPosition-request>)))
  ...
  "robotino_node/SetEncoderPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderPosition-request)))
  "Returns string type for a service object of type 'SetEncoderPosition-request"
  "robotino_node/SetEncoderPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-srv:<SetEncoderPosition-response> is deprecated: use robotino_node-srv:SetEncoderPosition-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderPosition-response>)))
  ...
  "robotino_node/SetEncoderPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderPosition-response)))
  "Returns string type for a service object of type 'SetEncoderPosition-response"
  "robotino_node/SetEncoderPositionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderPosition)))
  ...
  "robotino_node/SetEncoderPosition")