...
(cl:defmethod cl:initialize-instance :after ((m <ResetOdometry-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetOdometry-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-srv:<ResetOdometry-request> is deprecated: use robotino_node-srv:ResetOdometry-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-srv:x-val is deprecated.  Use robotino_node-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-srv:y-val is deprecated.  Use robotino_node-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-srv:phi-val is deprecated.  Use robotino_node-srv:phi instead.")
  (phi m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetOdometry-request>)))
  ...
  "robotino_node/ResetOdometryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetOdometry-request)))
  "Returns string type for a service object of type 'ResetOdometry-request"
  "robotino_node/ResetOdometryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ResetOdometry-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetOdometry-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-srv:<ResetOdometry-response> is deprecated: use robotino_node-srv:ResetOdometry-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetOdometry-response>)))
  ...
  "robotino_node/ResetOdometryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetOdometry-response)))
  "Returns string type for a service object of type 'ResetOdometry-response"
  "robotino_node/ResetOdometryResponse")
