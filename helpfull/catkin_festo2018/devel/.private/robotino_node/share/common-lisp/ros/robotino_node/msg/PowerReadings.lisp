...
(cl:defmethod cl:initialize-instance :after ((m <PowerReadings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerReadings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-msg:<PowerReadings> is deprecated: use robotino_node-msg:PowerReadings instead.")))
...
(cl:defmethod voltage-val ((m <PowerReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-msg:voltage-val is deprecated.  Use robotino_node-msg:voltage instead.")
  (voltage m))
