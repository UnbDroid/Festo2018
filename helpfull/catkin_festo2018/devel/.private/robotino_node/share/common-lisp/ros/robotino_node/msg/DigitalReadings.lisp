...
(cl:defmethod cl:initialize-instance :after ((m <DigitalReadings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalReadings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_node-msg:<DigitalReadings> is deprecated: use robotino_node-msg:DigitalReadings instead.")))
...
(cl:defmethod values-val ((m <DigitalReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotino_node-msg:values-val is deprecated.  Use robotino_node-msg:values instead.")
  (values m))
