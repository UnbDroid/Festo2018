...
if("TRUE" STREQUAL "TRUE")
  set(robotino_local_planner_SOURCE_PREFIX /home/simon/catkin_ws/src/robotino-ros-pkg/robotino_local_planner)
  set(robotino_local_planner_DEVEL_PREFIX /home/simon/catkin_ws/devel)
  ...
  set(robotino_local_planner_INSTALL_PREFIX /home/simon/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotino_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Suraj Nair <suraj.nair@tum-create.edu.sg>, Aravind V <aravind.v@tum-create.edu.sg>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotino_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simon/catkin_ws/src/robotino-ros-pkg/robotino_local_planner/${idir}'.  Ask the maintainer 'Suraj Nair <suraj.nair@tum-create.edu.sg>, Aravind V <aravind.v@tum-create.edu.sg>' to fix it.")
    endif()
