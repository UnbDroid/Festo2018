...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4IB.pack(_x.stamp.secs, _x.stamp.nsecs, _x.seq, _x.numServos, _x.torqueEnabled))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.stamp.secs, _x.stamp.nsecs, _x.seq, _x.numServos, _x.torqueEnabled,) = _struct_4IB.unpack(str[start:end])
